  ...
  `}
        >
            ...
            <div className="flex gap-2 justify-start items-center">
                <img
                    src={contacto.telefonoInfo?.bandera}
                    alt={contacto.telefonoInfo?.iso}
                    className="w-5 h-4 rounded-sm"
                />
                <p className="font-mono text-sm text-text-secondary">
                    {resaltar(contacto.telefonoInfo?.formateado || telefono)}
                </p>
            </div>
            ...
            <div className="flex justify-center items-center gap-4 my-1">
                ...
                <btn title="Detalle Contacto" className="text-icon-btn  hover:text-icon-btn-hover" onClick={irDetalleContacto}>
